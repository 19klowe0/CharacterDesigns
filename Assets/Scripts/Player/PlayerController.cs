...
public class PlayerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //ItemInWorld.SpawnItemInWorld(new Vector3(20, 20), new Item { itemType = Item.ItemType.ConstructionHat, amount = 1 });
    ...
    private void Update()
    {
        //can still transform into butterfly while dialogure is playing
